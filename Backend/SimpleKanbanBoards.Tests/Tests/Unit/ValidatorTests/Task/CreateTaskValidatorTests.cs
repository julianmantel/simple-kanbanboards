...
namespace SimpleKanbanBoards.Tests.Unit.ValidatorTests.Task
{
    public class CreateTaskValidatorTests
    {
        ...
        {
            var model = new CreateTaskModel { Title = "", Description = "Description", ServiceClass = "Expedite", Priority = 1, IdBoardColumn = 1 };
        ...
        {
            var model = new CreateTaskModel { Title = "Title", Description = "", ServiceClass = "Expedite", Priority = 1, IdBoardColumn = 1 };
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new CreateTaskModel { Title = "Title", Description = "Description", ServiceClass = "", Priority = 1, IdBoardColumn = 1 };
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new CreateTaskModel { Title = "Title", Description = "Description", ServiceClass = "Expedite", Priority = -1, IdBoardColumn = 1 };
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new CreateTaskModel { Title = "My Task", Description = "A description", ServiceClass = "Expedite", Priority = 5, IdBoardColumn = 1 };
            var result = _validator.TestValidate(model);
